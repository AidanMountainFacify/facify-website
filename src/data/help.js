// Placeholder structure — replace question/answer/body text with real
// support content. Category names and tutorial titles are grounded in
// actual product areas (Circuits, Contacts, Dashboard, Touchpoints).

export const faqCategories = [
  {
    category: 'Getting Started',
    items: [
      { question: '[Add FAQ question]', answer: '[Add answer]' },
      { question: '[Add FAQ question]', answer: '[Add answer]' },
      { question: '[Add FAQ question]', answer: '[Add answer]' },
    ],
  },
